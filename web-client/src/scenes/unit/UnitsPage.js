...
import { deleteAll, findAll } from "../../actions/units";
...
const mapStateToProps = (state) => ({
  ...
  error: state.Units.error || state.Units.error,
  loading: state.Units.loading || state.Units.loading,
  deleteData: state.Units.data,
  deleteError: state.Units.error
});
